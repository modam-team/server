...
public class ReportController {
    ...
    @GetMapping("/monthly")
    public ResponseDTO<List<ReportResponse>> getReport(@AuthenticationPrincipal CustomUserDetails user) {
        long userId = user.getUser().getId();
        List<ReportResponse> response = reportService.getReportData(userId);
